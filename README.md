...
## Примеры запусков (и соответствующие результуаты)
1) -i ./data/tsv_files/test_1.tsv -o ./data/pictures/test_1/ -m 100000 -f 0
2) -i ./data/tsv_files/test_2.tsv -o ./data/pictures/test_2/ -m 100000 -f 100
3) -i ./data/tsv_files/test_3.tsv -o ./data/pictures/test_3/ -m 10000000 -f 10000